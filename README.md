...
# E-commerce App: with RestAPI, Flutter & Provider 

This is a Flutter-based E-commerce app, using Provider for state management and API for dynamic product integration, ensuring a smooth user experience.
